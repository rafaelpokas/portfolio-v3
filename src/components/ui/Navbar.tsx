    ...
    >
      ...
      >
        <div className="flex flex-col gap-1.5 w-6">
          <span className={`block h-px bg-text-main transition-transform duration-300 ${isOpen ? "rotate-45 translate-y-[4px]" : ""}`} />
          <span className={`block h-px bg-text-main transition-opacity duration-300 ${isOpen ? "opacity-0" : ""}`} />
          <span className={`block h-px bg-text-main transition-transform duration-300 ${isOpen ? "-rotate-45 -translate-y-[4px]" : ""}`} />
        </div>
      </button>
